function Field(elementId){	
	...
	this.firstDownLine = function(yardLine){
		...
		if(this.oldFirstDown != null){
			this.ctx.beginPath();
			this.ctx.moveTo(this.oldFirstDown, 0);
			this.ctx.lineTo(this.oldFirstDown, 300);
			
			if(this.oldFirstDown % 60 == 0)
				this.ctx.strokeStyle = "white";
			else
				this.ctx.strokeStyle = "rgb(0, 153, 41)";
		...
		this.oldFirstDown = yardLine * 2 * 3 + 60;
	}
